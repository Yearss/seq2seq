...
class Vocab(object):
    ...
    def __init__(self, vocab_file, max_size):
        ...
        self._count, " ".join([self._id_to_word[self._count - i - 1] for i in range(10)]).encode("utf-8")))
...
# def example_generator_v1(data_path, single_pass):
#     """Generates tf.Example form another format data files
#
#       Data format: <article_id>\t<article_title>\t<article_content>\t<cate>
#
#     Args:
...
#
#     Yields:
#         Descialized tf.Example
#     """
#
#     while True:
#         with codecs.open(data_path, "r", encoding="utf-8") as f:
#             for line in f:
#                 content, title = line.strip().split("\t")
#                 example = tf.train.Example(
#                     features=tf.train.Features(
#                         feature={
#                             "content": tf.train.Feature(
#                                 string_list=tf.train.In
#                             )
#                         }
#                     )
#                 )
